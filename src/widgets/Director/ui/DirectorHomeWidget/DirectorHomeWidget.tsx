...
import styles from './DirectorHomeWidget.module.scss'
import mobile from './DirectorHomeWidgetMobile.module.scss'

export const DirectorHomeWidget: React.FC = () => {
    
    const directorData = {
        name: 'Арынов Максатбек Дуйшенкулович',
        position: 'Директор МП Тазалык',
